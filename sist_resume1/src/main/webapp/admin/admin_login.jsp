...
<div class="container">
	...
	<form action="http://localhost/sist_resume/admin/admin_login.jsp" id="admin_frm">
		<div>
				...
				<div class="margin1">
					...
					<div class="input-group">
						<div class="input-group-addon" aria-label="center Align">
						 ...
						 <input type="password" class="form-control"  name="admin_id" style="height: 50px"  aria-label="Large"  id="admin_id" placeholder="아이디를 입력하세요">
					</div>
				</div>
				<div class="margin1">
					<label>비밀번호</label>
...
%>
<jsp:useBean id="aVO" class="valueObject.adminLoginVO" scope="page"/>
<jsp:setProperty property="*" name="aVO"/>

<c:catch var="e">
<%
//String password=DataEncrypt.messageDigest( "MD5", request.getParameter("admin_pass"));
String password=request.getParameter("admin_pass"); //테스트 후 삭제
