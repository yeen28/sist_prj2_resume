...
<div id="container">
      <h2 class="sign-title"><strong>회원가입</strong></h2>
        <form role="form" class="new_user" id="new_user" name="new_user" action="<%= protocol %><%= domain %><%= contextRoot %>/process/sign_up_process.jsp" accept-charset="UTF-8" method="post">
        <div>
        </div>
