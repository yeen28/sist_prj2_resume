...
<form action="portfolio_write_update_process.jsp" method="post" id="portfolio_write_frm">
<div id="container">
	...
	<div id="prj1">
		...
		<div id="prj3">
			<label>프로젝트</label>
    		<input type="text" id="inputProject" class="form-control" placeholder="입력" name="proj_title" value="">
		</div>
		<div id="year">
			<label>제작 연도</label>
		...
		<div id="contents">
			<label>상세 업무 및 성과<span style="font-size: 10px"></span></label>
